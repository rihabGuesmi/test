...
<div class="row">
  ...
  <div class="col-md-3 col-xs-6">
    <div class="container-fluid">
      <div class="card" style="width: 20rem; margin-top:20px; margin-bottom:10px">
        <img class="card-img-top" src="watch.jpg" alt="Card image cap" style="width:255px; height:300px">
  ...
  <div class="col-md-3 col-xs-6">
    <div class="container-fluid">
      <div class="card" style="width: 20rem; margin-top:20px; margin-bottom:10px">
        <img class="card-img-top" src="pc.jpg" alt="Card image cap" style="width:255px; height:300px">
        <div class="card-block">
          <h4 class="card-title">Card title</h4>
  ...
  <div class="col-md-3 col-xs-6">
    <div class="container-fluid">
      <div class="card" style="width: 20rem; margin-top:20px; margin-bottom:10px">
        <img class="card-img-top" src="dress.jpg" alt="Card image cap" style="width:255px; height:300px">
        <div class="card-block">
          <h4 class="card-title">Card title</h4>
...
<div class="container lang">
  <div class="row">
    <div class="col-md-6">
      <img src="logo.png" alt="bottomLogo" width="110px" height="50px" style="margin-left:400px; margin-top:20px">
    </div>
    <div class="col-md-6">
